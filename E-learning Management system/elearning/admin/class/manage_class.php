	...
	<div class="col-lg-12">
		...
		<form action="" id="manage_class">
			...
			<div class="form-group">
				...
				<input type="text" name="level" id="level" class="form-control form-control-sm"  required value="<?php echo isset($level) ? $level : ''; ?>" >
			</div>
			<div class="form-group">
	        ...
	        <input type="button" data-dismiss="modal" name="Cnacel" value="Cancel">
		</form>
	</div>
</div>

...
<form action="" id="student-frm">
	<div class="row">
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control form-control-sm" name="firstname" id="firstname" value="<?php echo isset($firstname) ? $firstname : '' ?>" required pattern="[A-Za-z]{10}">
			</div>
			<div class="form-group">
	...
	<input type="submit" id="footer-grid1-newsletter-submit" name="submit" value='submit'>
	<input type="button" data-dismiss="modal" name="Cancel" value="Cancel">
</form>
<style>
	img#cimg{
		height: 15vh;
